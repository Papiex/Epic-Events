...
class TestGetEndpoint:
    def test_should_get_list(self, api_client, gestion_user):
        """test get list of customers objects with gestrion user"""
        payload = {
            "first_name": "test",
            "last_name": "test",
            "email": "test@mail.fr",
    ...
    def test_should_get_detail(self, api_client, gestion_user, create_customer):
        """test get detail of customer object with gestion user"""
