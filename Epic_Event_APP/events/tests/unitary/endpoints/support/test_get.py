...
class TestGetEndpoint:
    ...
    def test_should_get_list(self, api_client, create_contract, support_user, create_customer, saler_user):
        """test get list with support user"""
    ...
    def test_should_get_detail(self, api_client, create_event, support_user):
        """test get detail with support user"""
