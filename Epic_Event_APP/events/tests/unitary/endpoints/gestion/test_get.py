...
class TestGetEndpoint:
    ...
    def test_should_get_list(self, api_client, gestion_user, create_contract, support_user, create_customer, saler_user):
        """test get list with gestion user"""
    ...
    def test_should_get_detail(self, api_client, gestion_user, create_event):
        """test get detail with gestion user"""
