...
class ContractPermission(BasePermission):
    ...
    def has_permission(self, request, view) -> bool:
        ...
        if request.method == 'POST':
            ...
            return customer.sales_contact_id == request.user and request.user.role == 'SALER' or request.user.role == 'GESTION'
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method == 'PUT' or request.method == 'PATCH':
            if request.user.role == 'GESTION':
                ...
                return request.user == obj.customer_id.sales_contact_id and request.user == obj.sales_contact_id and request.user.role == 'SALER'
