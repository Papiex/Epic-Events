...
class TestGetEndpoint:
    ...
    def test_should_get_list(self, api_client, gestion_user, create_customer, saler_user):
    ...
    def test_should_get_detail(self, api_client, gestion_user, create_contract):
