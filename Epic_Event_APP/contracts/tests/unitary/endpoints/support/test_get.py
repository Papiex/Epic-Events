...
class TestGetEndpoint:
    ...
    def test_should_get_list(self, api_client, create_customer, saler_user, support_user):
        """test get list with support_user"""
        payload = {
    ...
    def test_should_get_detail(self, api_client, support_user, create_contract):
        """test get detail with support_user"""
