...
class TestFilters:
    def test_should_return_five_results_with_email(
        self, api_client, saler_user, payload_01, payload_02
    ):
    ...
    def test_should_return_five_results_with_last_name(
        self, api_client, saler_user, payload_01, payload_02
    ):
    ...
    def test_should_return_five_results_with_amount(
        self, api_client, saler_user, payload_01, payload_02
    ):
    ...
    def test_should_return_five_results_with_date_created(
        self, api_client, saler_user, payload_01, payload_02
    ):
